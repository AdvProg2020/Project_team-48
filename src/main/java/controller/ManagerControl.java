...
public class ManagerControl {
    ...
    public static void createDiscount(int discountCode,String startTime,String endTime,int percent,int repeat, String usersList){
        ArrayList<Account> users = new ArrayList<>();
        for (String s : usersList.split(",")) {
           users.add( Account.getUserByName(s));
        }
        new Discount(discountCode,startTime,endTime,percent,repeat,users);
    }
